...
public class RegistrationService {
    ...
    @Transactional
    public String confirmToken(String token) { //O token vai ser enviado para o email do user, portanto quando ele é validado tem sempre de ser so por esse user
